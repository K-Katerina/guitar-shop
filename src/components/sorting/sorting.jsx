...
const Sorting = ({className}) => {
    ...
    return (
        <div className={`sorting ${className}`}>
            ...
            <span onClick={() => onSortTypeChange(SortingTypes.PRICE)} className={`sorting__item ${sortingType === SortingTypes.PRICE && 'sorting__item--active'}`}>
                по&nbsp;цене
            </span>
            <span onClick={() => onSortTypeChange(SortingTypes.POPULAR)} className={`sorting__item ${sortingType === SortingTypes.POPULAR && 'sorting__item--active'}`}>
                по&nbsp;популярности
            </span>
            <div className="sorting__wrapper">
                <div onClick={() => onSortOrderChange(SortingOrders.TO_HIGH)} className={`sorting__item sorting__item--img ${sortingOrder === SortingOrders.TO_HIGH && 'sorting__item--active'}`}>
                ...
                <div onClick={() => onSortOrderChange(SortingOrders.TO_LOW)} className={`sorting__item sorting__item--img ${sortingOrder === SortingOrders.TO_LOW && 'sorting__item--active'}`}>
                    <svg width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
